...
import { Subscription, SubscriptionInsert, SubscriptionUpdate, Category } from '../types/supabase';
...
export const getLocalSubscriptions = async (): Promise<Subscription[]> => {
  try {
    ...
    throw new Error(
      `Failed to fetch local subscriptions: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const getLocalSubscriptionById = async (id: string): Promise<Subscription | null> => {
  try {
    ...
    throw new Error(
      `Failed to fetch local subscription: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const saveLocalSubscriptions = async (subscriptions: Subscription[]): Promise<void> => {
  try {
    ...
    throw new Error(
      `Failed to save local subscriptions: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
  ...
  try {
    ...
    const newSubscription: Subscription = {
      ...
      next_billing_date:
        ...
        calculateNextBillingDate(subscription.start_date, subscription.billing_cycle)
          .toISOString()
          .split('T')[0],
    ...
    throw new Error(
      `Failed to create local subscription: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const updateLocalSubscription = async (
  ...
  try {
    ...
    throw new Error(
      `Failed to update local subscription: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const deleteLocalSubscription = async (id: string): Promise<boolean> => {
  try {
    ...
    throw new Error(
      `Failed to delete local subscription: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const getLocalCategories = async (): Promise<Category[]> => {
  try {
    ...
    throw new Error(
      `Failed to fetch local categories: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const saveLocalCategories = async (categories: Category[]): Promise<void> => {
  try {
    ...
    throw new Error(
      `Failed to save local categories: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const createDefaultLocalCategories = async (): Promise<Category[]> => {
  try {
    ...
    throw new Error(
      `Failed to create default local categories: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const createLocalCategory = async (
  ...
  try {
    ...
    throw new Error(
      `Failed to create local category: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const updateLocalCategory = async (
  ...
  try {
    ...
    throw new Error(
      `Failed to update local category: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
...
export const deleteLocalCategory = async (id: string): Promise<boolean> => {
  try {
    ...
    throw new Error(
      `Failed to delete local category: ${error instanceof Error ? error.message : String(error)}`
    );
  }
};
