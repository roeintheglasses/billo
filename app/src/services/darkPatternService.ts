...
export const getAllDarkPatterns = async (): Promise<DarkPattern[]> => {
  try {
    const { data, error } = await supabase.from('dark_patterns').select('*').order('name');
...
export const getDarkPatternById = async (id: string): Promise<DarkPattern | null> => {
  try {
    const { data, error } = await supabase.from('dark_patterns').select('*').eq('id', id).single();
...
export const searchDarkPatterns = async (query: string): Promise<DarkPattern[]> => {
  try {
    ...
    const { data, error } = await supabase.from('dark_patterns').select('*');
 ...
 */
export const updateDarkPattern = async (
  id: string,
  updates: DarkPatternUpdate
): Promise<DarkPattern> => {
  try {
...
export const deleteDarkPattern = async (id: string): Promise<boolean> => {
  try {
    const { error } = await supabase.from('dark_patterns').delete().eq('id', id);
...
export const getDarkPatternCategories = async (): Promise<string[]> => {
  try {
    const { data, error } = await supabase.from('dark_patterns').select('category');
