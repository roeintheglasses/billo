...
import { Subscription, Transaction, Category, Notification, DarkPattern } from '../types/supabase';
 ...
 * @returns A validation result
 */
export const validateSubscription = (subscription: Partial<Subscription>): ValidationResult => {
...
export const validateCategory = (category: Partial<Category>): ValidationResult => {
  const results: ValidationResult[] = [validateRequired(category.name, 'name')];
 ...
 * @returns A validation result
 */
export const validateNotification = (notification: Partial<Notification>): ValidationResult => {
  const results: ValidationResult[] = [
